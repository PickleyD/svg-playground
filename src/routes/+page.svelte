<script lang="ts">
	...
	for (let i = 0; i < numCirclesY; i++) {
		let y = startOffset + i * 90;
		for (let j = 0; j < numCirclesX; j++) {
			centers.push([startOffset + j * 90, y]);
		}
	}
	...
	for (let i = 0; i < numCirclesY * 2 - 1; i++) {
		...
		for (let j = 0; j < numCirclesX * 2 - 1; j++) {
			...
			edgeCenters.push([startOffset + j * 45, y]);
		}
	}
	...
	for (let i = 0; i < numCirclesY * 2 - 1; i++) {
		...
		for (let j = 0; j < numCirclesX * 2 - 1; j++) {
			...
			smolCenters.push([startOffset + j * 45, y]);
		}
	}
	...
	for (let i = 0; i < numCirclesY * 2 - 1; i++) {
		...
		for (let j = 0; j < numCirclesX * 2 - 1; j++) {
			...
			smolMaybeCenters.push([startOffset + j * 45, y]);
		}
	}
